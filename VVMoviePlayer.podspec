Pod::Spec.new do |s|
  ...
  s.platform     = :ios 
  s.source       = { :git => "https://github.com/volarvideo/ios-volar-public-framework.git", :tag => "v2.0.0" }
  ...
  s.frameworks = 'CoreLocation', 'Security', 'CFNetwork', 'MapKit', 'EventKitUI', 'EventKit', 'CoreMedia', 'AVFoundation', 'SystemConfiguration', 'MediaPlayer', 'ImageIO', 'MessageUI', 'QuartzCore', 'UIKit', 'Foundation', 'CoreGraphics'
  s.dependency 'libPusher', '1.4'
  s.libraries = 'icucore', 'z', 'xml2'
